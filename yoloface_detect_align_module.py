...
# 其中 centerface，dbface，retinaface，mtcnn，yoloface，libface
# 这六个人脸检测网络在输出检测框的同时还输出人脸里的5个关键点， 用这5个关键点可以做人脸对齐的
# 在人脸识别中，人脸对其并非是必选项
class yoloface():
    # def __init__(self, net_type = 'mbv3_small_1_light', device = 'cuda', align=False):
    def __init__(self, net_type = 'mbv3_small_1_light', device = 'cuda', align=True):
