...
# device = 'cpu'
# detector = yoloface(device=device)
                    ...
                    if save_flag:
                        ...
                        if kk == ord('s'):
                            ...
                            if self.press_n_flag:
                                ...
                                finPicPath = current_face_dir + "/img_face_" + str(self.ss_cnt) + ".jpg"
                                cv2.imwrite(finPicPath, img_blank)
                                cv2.imencode('.jpg', img_blank)[1].tofile(finPicPath)
                                # cv2.imencode('.jpg', frame)[1].tofile('E:/中文1/中文2.jpg')
