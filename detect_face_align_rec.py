...
from mtcnn_pfld_landmark import pfld_landmark
import pickle
import cv2
import numpy as np
...
if __name__ == '__main__':
    ...
    # parser.add_argument('--imgpath', type=str, default='hq1.jpg', help='Path to image file.')
    # parser.add_argument('--imgpath', type=str, default='testbig2.jpg', help='Path to image file.')
    parser.add_argument('--imgpath', type=str, default='imgSma1.jpg', help='Path to image file.')
    ...
    # face_keypoint = pfld_landmark(device=device)
